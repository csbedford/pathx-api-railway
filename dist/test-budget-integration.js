...
exports.testBudgetService = testBudgetService;
...
async function testBasicBudgetValidation() {
    ...
    const result = await budget_1.budgetService.validateBudget(input);
    ...
    const invalidResult = await budget_1.budgetService.validateBudget(invalidInput);
...
async function testBudgetOptimization() {
    ...
    const optimizedBudget = await budget_1.budgetService.optimizeBudget(input);
...
//# sourceMappingURL=test-budget-integration.js.map