...
const partner_js_1 = require("../types/partner.js");
const partnerService_js_1 = require("../services/partnerService.js");
const prisma_js_1 = __importDefault(require("../lib/prisma.js"));
async function registerPartnerRoutes(app) {
    const partnerService = new partnerService_js_1.PartnerService(prisma_js_1.default);
    ...
    app.post('/partners', {
        ...
        try {
            const data = partner_js_1.CreatePartnerSchema.parse(request.body);
    ...
    app.get('/partners', {
        ...
        try {
            const searchParams = partner_js_1.PartnerSearchSchema.parse(request.query);
    ...
    app.put('/partners/:id', {
        ...
        try {
            const { id } = request.params;
            const data = partner_js_1.UpdatePartnerSchema.parse(request.body);
            const userId = request.user?.id || 'system';
    ...
    app.post('/partners/bulk', {
        ...
        try {
            const data = partner_js_1.BulkPartnerOperationSchema.parse(request.body);
            const userId = request.user?.id || 'system';
    ...
    app.post('/partners/:id/health', {
        ...
        try {
            const { id } = request.params;
            const data = partner_js_1.PartnerHealthMetricSchema.parse(request.body);
    ...
    app.post('/partners/:id/capabilities', {
        ...
        try {
            const { id } = request.params;
            const data = partner_js_1.PartnerCapabilitySchema.parse(request.body);
            const userId = request.user?.id || 'system';
    ...
    app.post('/partners/:id/creative-specs', {
        ...
        try {
            const { id } = request.params;
            const data = partner_js_1.CreativeSpecSchema.parse(request.body);
            const userId = request.user?.id || 'system';
    ...
    app.post('/partners/campaign-associations', {
        ...
        try {
            const data = partner_js_1.CampaignPartnerAssociationSchema.parse(request.body);
            const userId = request.user?.id || 'system';
    ...
    app.post('/partners/compare', {
        ...
        try {
            const data = partner_js_1.CapabilityComparisonSchema.parse(request.body);
    ...
    app.patch('/partners/:id/onboarding', {
        ...
        try {
            const { id } = request.params;
            const { status, step } = request.body;
            const userId = request.user?.id || 'system';
